...
SELECT 
    ...
    I.Machine_Age,
    I.Manufacturer,
    SUM(CASE WHEN D.Planned = 1 THEN D.Duration_hours ELSE 0 END) AS TOTAL_DURATION_HOURS_PLANNED,
    SUM(CASE WHEN D.Planned = 0 THEN D.Duration_hours ELSE 0 END) AS TOTAL_DURATION_HOURS_UNPLANNED
FROM Machine_Info I
